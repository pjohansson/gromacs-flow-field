...
TEST_F(GmxSaltbrTest, BasicOutputWorks)
{
    ...
    setOutputFileWithGeneratedName("min-min.xvg", XvgMatch().tolerance(tolerance));
    setOutputFileWithGeneratedName("plus-min.xvg", XvgMatch().tolerance(tolerance));
    setOutputFileWithGeneratedName("plus-plus.xvg", XvgMatch().tolerance(tolerance));
